...
CREATE TABLE `PasswordForgot` (
    ...
    UNIQUE INDEX `PasswordForgot_userId_key`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ChatParticipant` (
    ...
    UNIQUE INDEX `ChatParticipant_chatId_key`(`chatId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Message` (
    `id` VARCHAR(191) NOT NULL,
    `chatId` VARCHAR(191) NOT NULL,
    `chatParticipantId` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Message` ADD CONSTRAINT `Message_chatParticipantId_fkey` FOREIGN KEY (`chatParticipantId`) REFERENCES `ChatParticipant`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `MessageSeen` ADD CONSTRAINT `MessageSeen_chatParticipantId_fkey` FOREIGN KEY (`chatParticipantId`) REFERENCES `ChatParticipant`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
